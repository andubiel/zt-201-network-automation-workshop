...
TIP: You can start the lab exerircises below now or optionally review the workshop overview and details in a separate browser window here: link:https://rhpds.github.io/zt-network-automation-workshop[https://rhpds.github.io/zt-network-automation-workshop^]
