...
Both spines act as EVPN route relays. All four leafs are VTEPs sourcing VXLAN tunnels from Loopback0. Three data VLANs (40, 50, 60) are stretched across the fabric in VRF `gold` with symmetric IRB for inter-subnet routing.
